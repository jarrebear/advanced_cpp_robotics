#ifndef MAGIC_SUBSCRIBER_PCL2IMAGE_HPP
#define MAGIC_SUBSCRIBER_PCL2IMAGE_HPP
...
public:
  ...
  void init(const rclcpp::Node::SharedPtr &node,
    ...
    pointcloud_subscriber_ = node_->create_subscription<ROSMessageType>(
  ...
  template <typename PointCloudMessageType>
  void CallbackToTopic(const typename PointCloudMessageType::SharedPtr msg) {
    ...
    image_publisher_->publish(*output_image);
...
#endif // MAGIC_SUBSCRIBER_PCL2IMAGE_HPP
